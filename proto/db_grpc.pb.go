...
const (
	Database_Put_FullMethodName             = "/proto.Database/Put"
	Database_Get_FullMethodName             = "/proto.Database/Get"
	Database_Delete_FullMethodName          = "/proto.Database/Delete"
	Database_RequestVote_FullMethodName     = "/proto.Database/RequestVote"
	Database_AppendEntries_FullMethodName   = "/proto.Database/AppendEntries"
	Database_InstallSnapshot_FullMethodName = "/proto.Database/InstallSnapshot"
	Database_JoinCluster_FullMethodName     = "/proto.Database/JoinCluster"
)
...
func (c *databaseClient) JoinCluster(ctx context.Context, in *JoinClusterRequest, opts ...grpc.CallOption) (*JoinClusterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JoinClusterResponse)
	err := c.cc.Invoke(ctx, Database_JoinCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDatabaseServer) JoinCluster(context.Context, *JoinClusterRequest) (*JoinClusterResponse, error) {
...
func _Database_JoinCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(JoinClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DatabaseServer).JoinCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Database_JoinCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServer).JoinCluster(ctx, req.(*JoinClusterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Database_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Database_JoinCluster_Handler,
		},
	},
